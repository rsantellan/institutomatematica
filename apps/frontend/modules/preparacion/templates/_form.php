...
<?php endif; ?>
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        <th><?php echo $form['docente_id']->renderLabel();?></th>
        <td><?php echo $form['docente_id']->render();?></td>
        <td><?php echo $form['materia_id']->renderError();?></td>
      </tr>
      <tr>
        <th><?php echo $form['evaluacion_id']->renderLabel();?></th>
        <td><?php echo $form['evaluacion_id']->render();?></td>
        <td><?php echo $form['materia_id']->renderError();?></td>
      </tr>
      <tr>
        <th><?php echo $form['periodo']->renderLabel();?></th>
        <td><?php echo $form['periodo']->render();?></td>
        <td><?php echo $form['materia_id']->renderError();?></td>
      </tr>
      <tr>
